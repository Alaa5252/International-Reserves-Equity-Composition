...
See `software\_versions.txt` for the software environment used for the final replication run.
...
\- `software\_versions.txt` — software and user-written package information for the replication environment.
...
&#x20;   data/derived/analysis\_data.dta
...
`variable\_dictionary.xlsx` provides a crosswalk between:
...
The prefixes `L1\_` and `L2\_` denote first and second annual lags, respectively.
